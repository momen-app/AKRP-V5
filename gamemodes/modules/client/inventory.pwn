	...
	for (new i = 0; i < rows; i ++) if (i < MAX_DROPPED_ITEMS)
  	{
		...
		id = SQL_GetInt(i, "id");
		SQL_GetString(i, "itemName", DroppedItems[i][droppedItem]);
		DroppedItems[i][droppedModel] = SQL_GetInt(i, "itemModel");
		DroppedItems[i][droppedQuantity] = SQL_GetInt(i, "itemQuantity");
		DroppedItems[i][droppedPos][0] =  SQL_GetFloat(i, "itemX");
		DroppedItems[i][droppedPos][1] =  SQL_GetFloat(i, "itemY");
		DroppedItems[i][droppedPos][2] =  SQL_GetFloat(i, "itemZ");
		DroppedItems[i][droppedInt]    =  SQL_GetInt(i, "itemInt");
		DroppedItems[i][droppedWorld]  =  SQL_GetInt(i, "itemWorld");
